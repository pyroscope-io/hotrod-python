...
class MazeManager(object):
    ...
    Attributes:
        mazes (list): It is possible to have more than one services.maze. They are stored inside this variable.
    ...
    def convert_maze_to_image(self, id, cell_size=1):
        """Just show the generation animation and maze"""
        vis = Visualizer(self.get_maze(id), cell_size, self.media_name)
        return vis.convert_maze_to_image()
